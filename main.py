...
def higherLowerGame():
  ...
  while isWinner: 
    ...
    print(f"Compare A: {game_data[0]['name']}, a {game_data[0]['follower_count']}, from {game_data[0]['country']}")
    print(vs)
    print(f"Against B: {game_data[1]['name']}, a {game_data[1]['follower_count']}, from {game_data[1]['country']}")
